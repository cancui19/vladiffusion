#!/bin/bash
#SBATCH --job-name=vladiffusion_finetune_nuscenes_single_img_action_token_expl_from_ft_curr
...
INIT_LORA_DIR="/anvil/scratch/x-mgagvani/vladiffusion_scratch/VLA_finetune_nuscenes_single_image_train_20260101_1621_from_curr"
...
BASE_RUN_NAME="VLA_finetune_nuscenes_single_image_train_expl_${DATE}_from_ft_curr"
echo "BASE_RUN_NAME: ${BASE_RUN_NAME}"

# Use the Nu-X dataset to include narration/reasoning in the assistant targets.
# If you create a delta+Nu-X dataset, swap this path to keep delta planning behavior.
