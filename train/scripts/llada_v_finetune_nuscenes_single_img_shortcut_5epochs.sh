...
BASE_RUN_NAME="071425_llada_v_finetune_nuscenes_single_image_train_shortcut_5epochs"
...
python \
    ...
    --data_path "/home/cancui/Research/LLaDA-V/data/nuscenes_drive_data_single_image_train.json" \
    --image_folder "/" \
    --video_folder "/" \
    --lora_enable True \
    --lora_r 64 \
