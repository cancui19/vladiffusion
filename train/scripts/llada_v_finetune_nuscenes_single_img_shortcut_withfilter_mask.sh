...
BASE_RUN_NAME="071425_llada_v_finetune_nuscenes_single_image_train_filter_curvature_mask"
echo "BASE_RUN_NAME: ${BASE_RUN_NAME}"

python \
    llava/train/train_mem_mask.py \
    --model_name_or_path ${LLM_VERSION} \
    --version ${PROMPT_VERSION} \
    --data_path "/home/cancui/Research/LLaDA-V/data/nuscenes_drive_data_single_image_train_filter_curvature.json" \
    --image_folder "/" \
    --video_folder "/" \
    --lora_enable True \
    --lora_r 64 \
