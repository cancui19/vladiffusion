...
config_explanation = NuScenesVLAInferenceConfig(
    ...
    lora_path="/depot/ziran/apps/jiaru/projects/vladiffusion/exp/VLA_finetune_nuscenes_single_image_train_from_planning_explanation_20251130_1431",
    data_path="/depot/ziran/apps/jiaru/projects/vladiffusion/data/nuscenes_waypoint_text_long_prompt_val_Nu_X.json",
    results_path="/depot/ziran/apps/jiaru/projects/vladiffusion/results/vla_explanation_result.json",
    tokenizer_weights="/depot/ziran/apps/jiaru/projects/vladiffusion/tokenizer/tokenizer_model.pth",
    unused_token_ids_path="/depot/ziran/apps/jiaru/projects/vladiffusion/tokenizer/unused_token_ids.npy",
