...
class NuScenesVLAInferenceConfig:
    ...
    use_cache: bool = True
    pretrained: str = "/anvil/scratch/x-mgagvani/vladiffusion_scratch/VLA_finetune_nuscenes_single_image_train_expl_20260116_1636_from_ft_curr"
    model_base: str = "GSAI-ML/LLaDA-V"
    model_name: str = "llava_llada_lora"
    device: str = "cuda:0"
    device_map: str = "cuda:0"
    lora_path: str = "/anvil/scratch/x-mgagvani/vladiffusion_scratch/VLA_finetune_nuscenes_single_image_train_expl_20260116_1636_from_ft_curr"
    data_path: str = "data/nuscenes_delta_text_long_prompt_train.json"
    results_path: str = "/home/x-mgagvani/vladiffusion/results/vla_20260116_1636.json"
    ...
    generation_block_length: int = 128
...
config_explanation = NuScenesVLAInferenceConfig(
    ...
    model_name="llava_llada_lora",
    lora_path="/anvil/scratch/x-mgagvani/vladiffusion_scratch/VLA_finetune_nuscenes_single_image_train_expl_20260116_1636_from_ft_curr",
    data_path="data/nuscenes_delta_text_long_prompt_val_Nu_X.json",
    results_path="/home/x-mgagvani/vladiffusion/results/vla_explanation_20260116_1636.json",
