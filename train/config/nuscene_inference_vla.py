...
class NuScenesVLAInferenceConfig:
    ...
    use_cache: bool = True
    pretrained: str = "/anvil/scratch/x-mgagvani/vladiffusion_scratch/VLA_finetune_nuscenes_single_image_train_20251229_1244_from_curr"
    model_base: str = "GSAI-ML/LLaDA-V"
    model_name: str = "llava_llada_lora"
    device: str = "cuda:0"
    device_map: str = "cuda:0"
    lora_path: str = "/anvil/scratch/x-mgagvani/vladiffusion_scratch/VLA_finetune_nuscenes_single_image_train_20251229_1244_from_curr"
    data_path: str = "data/nuscenes_delta_text_long_prompt_train.json"
    results_path: str = "/home/x-mgagvani/vladiffusion/results/vla_20251229_1244.json"
