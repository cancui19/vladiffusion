...
job_name = 'single_image_train_lora_time_step_32_mask_threshold0.5'
...
for i, data_sample in enumerate(data_val):
    ...
    cont = model.generate_fix_mask(
        ...
        steps=32, tokenizer=tokenizer, stopping_criteria=['<|eot_id|>'], 
...
with open(f'/scratch/gilbreth/cancui/LLaDA-V/results/nuscenes_drive_data_single_image_val_inference_lora_{job_name}_no_cache_time.txt', 'w') as f:
