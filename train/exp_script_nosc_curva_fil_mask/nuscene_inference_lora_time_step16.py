...
job_name = 'single_image_train_lora_time_step_16_mask'
...
lora_path = '/home/cancui/Research/LLaDA-V/train/exp/071425_llada_v_finetune_nuscenes_single_image_train_filter_curvature_mask'
...
import json
with open('/home/cancui/Research/LLaDA-V/data/nuscenes_drive_data_single_image_val_filter_curvature.json', 'r') as f:
...
for i, data_sample in enumerate(data_val):
    ...
    template = "[02.98, +0000.00], [02.94, +0000.00], [02.84, +0000.00], [02.67, +0000.00], [02.35, -0000.00], [02.48, -0000.01], [02.28, -0000.01], [02.37, -0000.01], [02.43, -0000.01], [02.03, -0000.01]"
    template_ids = torch.tensor(tokenizer.encode(template, add_special_tokens=False))
    custom_mask_array = torch.tensor([True, False, False, True, False, False, True, False, False, False, False, False, True, False, False, True, 
                                      True, False, False, True, False, False, True, False, False, False, False, False, True, False, False, True, 
                                      True, False, False, True, False, False, True, False, False, False, False, False, True, False, False, True, 
                                      True, False, False, True, False, False, True, False, False, False, False, False, True, False, False, True, 
                                      True, False, False, True, False, False, True, False, False, False, False, False, True, False, False, True, 
                                      True, False, False, True, False, False, True, False, False, False, False, False, True, False, False, True, 
                                      ...
                                      True, False, False, True, False, False, True, False, False, False, False, False, True, False, False, True, 
                                      True, False, False, True, False, False, True, False, False, False, False, False, True, False, False, True])
    template_ids[torch.logical_not(custom_mask_array)] = 126336
    template_ids = template_ids.to(device).unsqueeze(0)
    ...
    cont = model.generate_fix_mask(
        ...
        steps=16, tokenizer=tokenizer, stopping_criteria=['<|eot_id|>'], verbose=False,
    )
    end_time = time.time()
    ...
    with open(f'/scratch/gilbreth/cancui/LLaDA-V/results/different_steps/nuscenes_drive_data_single_image_val_inference_lora_{job_name}.json', 'w') as f:
...
with open(f'/scratch/gilbreth/cancui/LLaDA-V/results/different_steps/nuscenes_drive_data_single_image_val_inference_lora_{job_name}_time.txt', 'w') as f:
    f.write(f"Total Steps: {16}\n")
